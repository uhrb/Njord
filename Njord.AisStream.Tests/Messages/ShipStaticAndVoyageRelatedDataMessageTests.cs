...
{
    public class ShipStaticAndVoyageRelatedDataMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public ShipStaticAndVoyageRelatedDataMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.ShipStaticData),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.ShipStaticData, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IShipStaticAndVoyageRelatedDataMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.ShipStaticData, result2.MessageType);
