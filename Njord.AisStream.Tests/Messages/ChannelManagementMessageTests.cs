...
{
    public class ChannelManagementMessageTests 
    {
        private readonly ITestOutputHelper _helper;

        public ChannelManagementMessageTests(ITestOutputHelper helper) 
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.ChannelManagement),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.ChannelManagement, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IChannelManagementMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.ChannelManagement, result2.MessageType);
