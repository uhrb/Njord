...
{
    public class CoordinatedUniversalTimeDateInquiryMessageTests 
    {
        private readonly ITestOutputHelper _helper;

        public CoordinatedUniversalTimeDateInquiryMessageTests(ITestOutputHelper helper) 
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.CoordinatedUTCInquiry),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.CoordinatedUTCInquiry, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as ICoordinatedUniversalTimeDateInquiryMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.CoordinatedUTCInquiry, result2.MessageType);
