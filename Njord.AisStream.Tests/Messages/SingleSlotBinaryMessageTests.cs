...
{
    public class SingleSlotBinaryMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public SingleSlotBinaryMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.SingleSlotBinaryMessage),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.SingleSlotBinaryMessage, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as ISingleSlotBinaryMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.SingleSlotBinaryMessage, result2.MessageType);
