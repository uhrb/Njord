...
{
    public class LongRangeAisBroadcastMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public LongRangeAisBroadcastMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.LongRangeAisBroadcastMessage),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.LongRangeAisBroadcastMessage, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as ILongRangeAisBroadcastMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.LongRangeAisBroadcastMessage, result2.MessageType);
