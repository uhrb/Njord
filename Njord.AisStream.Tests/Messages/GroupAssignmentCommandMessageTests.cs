...
{
    public class GroupAssignmentCommandMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public GroupAssignmentCommandMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.GroupAssignmentCommand),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.GroupAssignmentCommand, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IGroupAssignmentCommandMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.GroupAssignmentCommand, result2.MessageType);
