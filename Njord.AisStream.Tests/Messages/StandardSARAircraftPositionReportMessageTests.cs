...
{
    public class StandardSARAircraftPositionReportMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public StandardSARAircraftPositionReportMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.StandardSearchAndRescueAircraftReport),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.StandardSearchAndRescueAircraftReport, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IStandardSARAircraftPositionReportMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.StandardSearchAndRescueAircraftReport, result2.MessageType);
