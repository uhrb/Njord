...
{
    public class SafetyRelatedBroadcastMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public SafetyRelatedBroadcastMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.SafetyBroadcastMessage),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.SafetyBroadcastMessage, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as ISafetyRelatedBroadcastMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.SafetyBroadcastMessage, result2.MessageType);
