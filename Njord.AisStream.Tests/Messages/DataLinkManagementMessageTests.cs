...
{
    public class DataLinkManagementMessageTests 
    {
        private readonly ITestOutputHelper _helper;

        public DataLinkManagementMessageTests(ITestOutputHelper helper) 
        {
            _helper = helper;
        }
        ...
        [MemberData(
           ...
           "AisStreamMessages",
           nameof(AisStreamMessageType.DataLinkManagementMessage),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.DataLinkManagementMessage, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IDataLinkManagementMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.DataLinkManagementMessage, result2.MessageType);
