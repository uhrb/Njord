...
{
    public class GnssBroadcastBinaryMessageTests
    {
        private readonly ITestOutputHelper _helper;

        public GnssBroadcastBinaryMessageTests(ITestOutputHelper helper)
        {
            _helper = helper;
        }
        ...
        [MemberData(
            ...
            "AisStreamMessages",
            nameof(AisStreamMessageType.GnssBroadcastBinaryMessage),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.GnssBroadcastBinaryMessage, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IGnssBroadcastBinaryMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.GnssBroadcastBinaryMessage, result2.MessageType);
