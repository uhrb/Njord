...
{
    public class AidsToNavigationReportMessageTests 
    {
        private readonly ITestOutputHelper _helper;

        public AidsToNavigationReportMessageTests(ITestOutputHelper helper) 
        {
            _helper = helper;
        }
        ...
        [MemberData(
           ...
           "AisStreamMessages",
           nameof(AisStreamMessageType.AidsToNavigationReport),
        ...
        public void ConvertedWithoutExceptions(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.AidsToNavigationReport, result.MessageType);
            Assert.NotNull(result.Metadata);
            Assert.NotNull(result.Message);
            var typedMessage = result.Message as IAidsToNavigationReportMessage;
        ...
        public void ConvertedBackAndForce(ulong id, string message, bool valid)
        {
            ...
            Assert.Equal(AisStreamMessageType.AidsToNavigationReport, result2.MessageType);
